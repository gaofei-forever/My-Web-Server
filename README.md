...
性能
![image](https://user-images.githubusercontent.com/69200899/124857172-67138b80-dfde-11eb-8550-b6a92859c667.png)

在这里插入图片描述 用webbench压测工具 并发1000个请求 压测30s 用get请求 且用长连接 对server进行压测 结果如下
